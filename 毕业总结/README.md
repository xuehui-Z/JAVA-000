...
- Spring Cloud全家桶提供了各种各样的组件，基本可以覆盖微服务的服务治理的方方面面，以下列出了Spring Cloud一些常用组件：
  ...
  ![img](https://upload-images.jianshu.io/upload_images/7584230-16df8f7fbee37f37.png?imageMogr2/auto-orient/strip|imageView2/2/w/1200/format/webp)
...
优点：想了好久，不知道自己这些算不算优点：喜欢编程，有激情，有野心（我想要成为老师这样的人，有影响力，能帮助很多人）。

缺点：技术基础薄弱；没有耐心，学习不能够深入；软实力方面表达能力欠缺。

## 五年计划
2、（选做）针对自己的分析，规划自己未来1年、2年、3年、5年的职业发展。

- 2021年给自己的目标
  - 入职互联网公司。业务方面选择有前景的行业（在线教育，在线医疗。。）熟悉其线下的业务流程，多沟通多交流，就像老师说的，请前辈吃饭，向其取经；技术上一方面把这次训练营的知识消化掉，完成作业。另一方面学习工作中使用的技术以及其底层原理，能在公司小组内达到top10%。
  - 开始积累自己的影响力，参与开源，输出技术文章（争取每周一篇）
  - 软实力方面提高情商，学习蔡康永情商课，学会控制自己的情绪，多和朋友交流沟通
- 2-3年内的计划
  - 把比较火的技术都学习一边，选几个领域深入学习，现在感觉需要深入学习的一个是MySQL数据库
  - 在深入工作中往架构师这方向走
  - 结婚，买房
- 5年内的计划
  - 能够触摸到架构师的门槛，成为某一方面的专家。